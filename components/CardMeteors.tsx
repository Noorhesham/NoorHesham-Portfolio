    ...
    <div className="">
      <div className=" w-full relative max-w-xs">
        ...
        <div className="relative shadow-xl bg-gray-900 border border-gray-800  px-4 py-8 h-full overflow-hidden rounded-2xl flex flex-col justify-end items-start">
          ...
          <p className="text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300">{job.des} </p>
          <div className="w-full mt-4">
            <Image
              src={job.img}
              height="1000"
              width="1000"
              className=" h-full w-96 object-cover rounded-xl group-hover/card:shadow-xl"
              alt="thumbnail"
            />
          </div>
